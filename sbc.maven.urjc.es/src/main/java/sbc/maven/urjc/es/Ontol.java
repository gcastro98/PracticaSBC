...
/**
 * Clase encargada de gestionar ontologías.
 */
public class Ontol {
    ...
    public void addObjectProperty(String prop, String dominio, String rango) {
        try {
    ...
    public void createInstanciaWithObjectProperty(String nombre_propiedad, String nombre_individuo1, String clase_individuo1, String nombre_individuo2, String clase_individuo2) {
        ...
        try {
            ...
            //creo las instancias y la propiedad por separado.
    ...
    public void addPeliculas(List<Pelicula> peliculas) {
        for (Pelicula pelicula : peliculas) {
            for (Actor actor : pelicula.getReparto()) {
                createInstanciaWithObjectProperty("http://www.movieontology.org/2009/10/01/movieontology.owl#isActorIn", actor.getName(), "http://dbpedia.org/ontology/Actor", pelicula.getTitulo(), "http://www.movieontology.org/2009/11/09/Movie");
            }
            for (String productora : pelicula.getProductoras()) {
                createInstanciaWithObjectProperty("http://www.movieontology.org/2009/10/01/movieontology.owl#isProducedBy", pelicula.getTitulo(), "http://www.movieontology.org/2009/11/09/Movie", productora, "http://www.movieontology.org/2009/10/01/movieontology.owl#Production_Company");
            }
            for (String pais : pelicula.getPais()) {
                createInstanciaWithObjectProperty("http://www.movieontology.org/2009/10/01/movieontology.owl#hasReleasingCountry", pelicula.getTitulo(), "http://www.movieontology.org/2009/11/09/Movie", pais, "http://dbpedia.org/ontology/Country");
            }
            for (String genero : pelicula.getGeneros()) {
                createInstanciaWithObjectProperty("http://www.movieontology.org/2009/10/01/movieontology.owl#belongsToGenre", pelicula.getTitulo(), "http://www.movieontology.org/2009/11/09/Movie", genero, "http://www.movieontology.org/2009/10/01/movieontology.owl#Genre");
            }
            ...
            if (!pelicula.getEstreno().isEmpty())
                createInstanciaWithDataPropertyDate("http://www.movieontology.org/2009/10/01/movieontology.owl#releasedate", pelicula.getTitulo(), "http://www.movieontology.org/2009/11/09/Movie", pelicula.getEstreno());
    ...
    public void inferringInfo(List<Pelicula> movies) {
        for (Pelicula peli : movies) {
            Actor a = peli.actorEstrella();
            if (a != null) {
                createInstanciaWithObjectProperty("http://sbc2019Movie/ont/esLaEstrellaDe", a.getName(), "http://dbpedia.org/ontology/Actor", peli.getTitulo(), "http://www.movieontology.org/2009/11/09/Movie");

                if (peli.getGeneros().contains("Comedy"))
                    createInstanciaWithObjectProperty("http://sbc2019Movie/ont/esGraciosoEn", a.getName(), "http://dbpedia.org/ontology/Actor", peli.getTitulo(), "http://www.movieontology.org/2009/11/09/Movie");
            }
            if (peli.isExito()) {
                for (String prod : peli.getProductoras()) {
                    createInstanciaWithObjectProperty("http://sbc2019Movie/ont/esUnExitoDe", peli.getTitulo(), "http://www.movieontology.org/2009/11/09/Movie", prod, "http://www.movieontology.org/2009/10/01/movieontology.owl#Production_Company");
                }
            }
        }
    }
